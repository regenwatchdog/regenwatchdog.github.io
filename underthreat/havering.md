...
---
<div class="col">
<iframe src="{{ site.baseurl }}/underthreat/haveringmap.html" width="100%" height="400px"></iframe>
<p align="right">Click <a href="{{ site.baseurl }}/underthreat/haveringmap.html">here</a> to open map in new window.</p>
</div>
