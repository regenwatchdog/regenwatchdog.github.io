...
<iframe src="{{ site.baseurl }}/underthreat/kingstonmap.html" width="100%" height="400px"></iframe>
</div>
<p align="right">Click <a href="{{ site.baseurl }}/underthreat/kingstonmap.html">here</a> to open map in new window.</p>
</div>
<br>
