---
layout: default
title: Estates under threat in Westminster 
category: underthreat
---
<div class="col">
<iframe src="{{ site.baseurl }}/underthreat/westminstermap.html" width="100%" height="400px"></iframe>
<p align="right">Click <a href="{{ site.baseurl }}/underthreat/westminstermap.html">here</a> to open map in new window.</p>
</div>


<div class="col">
              <ul class="row list-unstyled justify-content-center">
{% assign schemes = site.estates | where:"borough","westminster" %}
